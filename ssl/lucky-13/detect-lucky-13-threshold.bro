...
##		x509_error_count: 0
##
##	In this version of the detector we are just going to fire on thresholds
##  We should probably just alert this as "SSL Anomoly: Too many attempted SSL connections"
